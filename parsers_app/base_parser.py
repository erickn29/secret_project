...
class BaseParser:
    ...
    SUPERJOBLINK = 'https://russia.superjob.ru/vacancy/search/?keywords=c%23%2Cpython%2Cjavascript%2Cphp%2Cc%2B%2B%2Cjava&payment_value=20000&period=3&payment_defined=1&click_from=facet'
    STOP_WORDS = ('машинист', 'водитель', 'таксист', 'курьер', 'охранник')
    ...
    @staticmethod
    def vacancies_to_db(vacancies_dict: dict):
